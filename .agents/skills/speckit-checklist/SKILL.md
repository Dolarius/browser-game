...
## Checklist Purpose: Requirements Quality Review

**CRITICAL CONCEPT**: Checklists review the quality, clarity, and completeness of requirements in a given domain.

**NOT for implementation verification**:

- ❌ NOT "Verify the button clicks correctly"
- ❌ NOT "Check error handling works"
...
Use the checklist to decide whether requirements are well-written, complete, unambiguous, and ready for implementation - NOT whether the implementation works.
...
6. **Generate checklist** - Create "Unit Tests for Requirements":
   ...
   **HOW TO WRITE CHECKLIST ITEMS - Requirements Quality Review**:

   ❌ **WRONG** (Checking implementation behavior):
   - "Verify landing page displays 3 episode cards"
   - "Check hover states work on desktop"
   - "Confirm logo click navigates home"

   ✅ **CORRECT** (Reviewing requirements quality):
